...
public class MallFilter implements Filter {
    ...
    private boolean auth(String requestURI) {
        ...
        if("/api/mall/user/login".equals(requestURI) || "/api/mall/user/logoutClient".equals(requestURI) || "/api/mall/user/signup".equals(requestURI) || requestURI1.startsWith("goods") || requestURI1.startsWith("index")){
            return false;
        }
        return true;
    }
